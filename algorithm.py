...
class DrawInformation:
    ...
    def __init__(self, width, height, lst):
        ...
        pygame.display.set_caption("Sorting Algorith Visualizer")
        self.set_list(lst) 
    ...
    def set_list(self, lst):
        ...
        # width / side padding = total drawable space, total drawable space / len(lst) = drawable space for each block
        self.block_width = round((self.width - self.SIDE_PAD ) / len(lst))

        # max - min value = range of list
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if event.key == pygame.K_r:
                ...
                sorting_algorithm_name = "Insrtion sort"
